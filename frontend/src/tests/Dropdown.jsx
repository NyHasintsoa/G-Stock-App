...
function Dropdown() {
  ...
  return (
    <div
      className={
        "hs-dropdown [--placement:bottom-right] relative inline-flex" +
        (isOpen ? " open" : "")
      }
    >
      <button
      ...
      <div
        className={
          "hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 min-w-60 bg-white shadow-md rounded-lg mt-2 dark:bg-neutral-800 dark:border dark:border-neutral-700 dark:divide-neutral-700 after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full" +
          (isOpen ? " block" : " hidden")
        }
        role="menu"
