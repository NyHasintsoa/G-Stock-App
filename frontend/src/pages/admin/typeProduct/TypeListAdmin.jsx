...
import TypeListItems from "./TypeListItems.jsx";
import Pagination from "../../../components/pagination/Pagination.jsx";
import Spinner from "../../../components/spinner/Spinner.jsx";
import typeService from "../../../services/TypeService.js";

function TypeListAdmin() {
  const {
    rows: typesProduct,
    page,
    totalPages,
    loading,
    onPageChange
  } = usePagination(typeService.getAllPaginated.bind(typeService), 10);
      ...
      <div className="border-[1px] rounded-xl p-5 border-gray-700">
        ...
        <div className="flex w-full overflow-x-auto">
          <table className="table-hover table-compact table">
            ...
            <tbody>
              {!loading ? (
                <TypeListItems typesProduct={typesProduct} />
              ) : (
                <tr>
                  <td colSpan={2}>
                    <Spinner />
